...
import { Send, Trash2, Sparkles, MessageCircle, Loader2, RotateCcw, Heart, Shield, Lightbulb } from "lucide-react";
      ...
      <CardHeader className="border-b bg-gradient-to-r from-rose-50 to-purple-50">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            <div className="w-10 h-10 rounded-full bg-gradient-to-br from-rose-400 to-purple-600 flex items-center justify-center text-white">
      ...
      <CardContent className="flex-1 overflow-y-auto p-4 space-y-4">
        ...
        {sendMessage.isPending && (
          <div className="flex items-start gap-3">
            <div className="w-8 h-8 rounded-full bg-gradient-to-br from-rose-400 to-purple-600 flex items-center justify-center flex-shrink-0">
      ...
      <div className={`max-w-[80%] ${isUser ? "text-right" : ""}`}>
        ...
        {!isUser && (
          <div className="flex items-center gap-2 mt-1 ml-1">
            <span className={`text-xs px-2 py-0.5 rounded-full flex items-center gap-1 ${categoryColor}`}>
              {categoryIcon}
