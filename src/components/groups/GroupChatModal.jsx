          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="flex items-center gap-1.5 mt-0.5">
                ...
                <p className="text-[10px] text-gray-500 uppercase tracking-[0.1em] font-black">Active Group</p>
              </div>
            </div>
          </div>
        ...
        <form onSubmit={handleSend} className="p-6 bg-white border-t border-gray-100">
          <div className="flex items-end gap-3 bg-gray-50/80 p-2 rounded-[2rem] border border-gray-100 focus-within:border-purple-200 focus-within:bg-white focus-within:shadow-lg focus-within:shadow-purple-50 transition-all">
            <button
              ...
              className="w-11 h-11 flex items-center justify-center bg-white rounded-full text-gray-400 hover:text-purple-600 hover:shadow-md transition-all active:scale-90"
            >
            ...
            <Popover>
              <PopoverTrigger asChild>
                <button
                  type="button"
                  className="w-11 h-11 flex items-center justify-center bg-white rounded-full text-gray-400 hover:text-rose-500 hover:shadow-md transition-all active:scale-90"
                >
            ...
            <Button 
              ...
              className="w-11 h-11 rounded-full bg-gradient-to-r from-purple-600 to-rose-600 hover:shadow-lg hover:shadow-purple-200 text-white p-0 transition-all active:scale-90 disabled:opacity-50 disabled:grayscale"
            >
